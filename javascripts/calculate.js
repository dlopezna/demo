...
function calculate(cantidad,latitud, longitud,sexo,radio ) {
...
var startlat=latLonToDecimal(latitud, 1, "latitude");
if (startlat == -999) {
clearRandomPoint();
return;
}
...
startlon=latLonToDecimal(longitud, 0, "longitude");
if (startlon == -999) {
clearRandomPoint();
return;
}
...
for (i=0; i<p; i++) {
	...
	var markerIcon = "http://labs.google.com/ridefinder/images/mm_20_gray.png"
	if (sexo=="F"){markerIcon = "http://labs.google.com/ridefinder/images/mm_20_purple.png";}
	var edad=0;
	edad = Math.floor(Math.random() * (65-16+1)) + 16;
	...
	marker.set("sexo",sexo);
	marker.set("edad",edad);
